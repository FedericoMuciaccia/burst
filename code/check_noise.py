...
file_list = glob.glob('/storage/users/Muciaccia/burst/data/new_data/Noise*.hdf5')

file_list.sort() # in-place
...
print('using model trained at SNR', minimum_trained_signal_to_noise_ratio)
...
for file_path in file_list:
    ...
    # all the images were noise (class = 0)
    wrongly_classified = predicted_classes
    ...
    for index in misclassified_indices[0:10]:
        ...
        pyplot.show()
        #pyplot.savefig('/storage/users/Muciaccia/burst/media/misclassified_noise/{}_index_{}.jpg'.format(file_name, index), bbox_inches='tight')
        pyplot.close()
